      ...
      <div class="col-md-3">
        <div class="form-group" :class="{ 'has-error': sumOfJob > jobLimit }">
          ...
          <div class="input-group input-group-sm">
            ...
            <span class="input-group-addon"> / {{ jobLimit }} </span>
          </div>
        </div>
      </div>
      <div class="col-md-3">
      ...
      <transition-group tag="tbody" name="fade">
        <template v-for="(skill, key) in skills">
          <skill-row-xs
            ...
            :value="skill"
            :index="key"
            @input="update({ id: key, skill: skill })"
            :class="{ danger: !isUnique }"
          ></skill-row-xs>
          <skill-row
            :key="`${skill.key}`"
            :value="skill"
    ...
    <modal id="skill">
      ...
      <div>
        <div class="form-inline form-group">
          ...
          <div class="form-group">
            <button
              ...
              :disabled="selectedSkillset === ''"
              data-dismiss="modal"
              @click="pushByArray(skillsets[selectedSkillset].skills)"
            >
        ...
        <div class="col-xs-12 table-responsive hidden-xs hidden-sm">
          <skillsets-skills-table
            v-if="!(selectedSkillset === '')"
          ...
          <div class="form-group">
            <button
              ...
              @click="
                push(
                  Object.assign(
                    { job_point: 0, interest_point: 0, others_point: 0 },
