<template>
  <tr>
    ...
    <td class="form-group">
      <input type="number" class="form-control input-sm" v-model.lazy.number="init" min="0" :readonly="!skill.is_custom || skill.reference !== null" >
    </td>
    <td class="form-group">
      <input type="number" class="form-control input-sm" v-model.lazy.number="skill.job_point" min="0">
    </td>
    <td class="form-group">
      <input type="number" class="form-control input-sm" v-model.lazy.number="skill.interest_point" min="0">
    </td>
    <td class="form-group">
      <input type="number" class="form-control input-sm" v-model.lazy.number="skill.others_point" min="0">
    </td>
